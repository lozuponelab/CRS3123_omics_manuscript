...
**File Paths**
```{r}
metadata_FP <- '../../../4_fecal_immune/data/sif_sample_metadata.tsv'
tax_FP <- '../data/taxonomy.qza'
#generated biplots using q_make_biplot_crs.sh
uu_biplot_FP <- '../data/crs_uu_biplot_matrix.qza'
wu_biplot_FP <- '../data/crs_wu_biplot_matrix.qza'
...
save(wu_biplot_facet, file = "../../../../manuscript_figures/fig_3a_wu_biplot.rdat")
```
